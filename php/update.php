...
<body>
    ...
    <div class="card">
        <div class="card-img">
            <lottie-player src="https://assets4.lottiefiles.com/packages/lf20_ky03n5aXvs.json" background="transparent" speed="1" style="width: 350px; height: 300px;" loop autoplay></lottie-player>
        </div>
